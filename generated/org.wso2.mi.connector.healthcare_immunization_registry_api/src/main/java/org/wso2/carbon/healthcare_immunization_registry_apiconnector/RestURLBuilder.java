...
package org.wso2.carbon.healthcare_immunization_registry_apiconnector;
...
public class RestURLBuilder extends AbstractConnector {
    ...
    private static final String GENERAL_ERROR_MSG = "healthcare_immunization_registry_api connector encountered an error: ";
    ...
    public static final Map<String, String> parameterNameMap = new HashMap<String, String>() {{
            ...
            put("vaccines", "vaccines");
            put("childName", "childName");
            put("municipality", "municipality");
            put("birthRegistrationNumber", "birthRegistrationNumber");
