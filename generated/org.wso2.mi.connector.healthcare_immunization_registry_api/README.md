# healthcare_immunization_registry_api Connector
...
1. To get started with connector configurations, see [Configuring healthcare_immunization_registry_api Connector](docs/config.md).
2. Follow [Working with healthcare_immunization_registry_api Connector](docs/operations.md) for information on the connector operations.
